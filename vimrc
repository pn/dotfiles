...
fun! SetupVAM()
  ...
  call vam#ActivateAddons(['UltiSnips','The_NERD_tree', 'The_NERD_Commenter', 'taglist', 'align', 'matchit.zip', 'Command-T', 'surround', 'repeat', 'ack', 'bufexplorer.zip', 'clang_complete', 'github:altercation/vim-colors-solarized', 'autoload_cscope', 'CCTree', 'Syntastic', 'vim-gitgutter', 'fugitive', 'powerline', 'vim-multiple-cursors'], {'auto_install' : 0})
endfun
call SetupVAM()
